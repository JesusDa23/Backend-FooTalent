...
checklist.createChecklist = async (req, res) => {
    try {
        ...
        const newChecklist = new ChecklistVehiculo({
            ...
            sistemaLuces: {
                luzDelanteraAlta: req.body.sistemaLuces.luzDelanteraAlta || false,
                luzDelanteraBaja: req.body.sistemaLuces.luzDelanteraBaja || false,
                lucesEmergencia: req.body.sistemaLuces.lucesEmergencia || false,
                lucesDireccionalesDelanteras: req.body.sistemaLuces.lucesDireccionalesDelanteras || false,
                lucesDireccionalesPosteriores: req.body.sistemaLuces.lucesDireccionalesPosteriores || false,
                luzReversa: req.body.sistemaLuces.luzReversa || false,
                lucesdeFrenoPosterior: req.body.sistemaLuces.lucesdeFrenoPosterior || false
            },
            parteExterna: {
                parabrisasDelantero: req.body.parteExterna.parabrisasDelantero || false,
                parabrisasPosterior: req.body.parteExterna.parabrisasPosterior || false,
                limpiaparabrisas: req.body.parteExterna.limpiaparabrisas || false,
                ...
                perdidadeFluidosPavimento: req.body.parteExterna.perdidadeFluidosPavimento || false
            },
            parteInterna: {
                tableroEstadoIndicadores: req.body.parteInterna.tableroEstadoIndicadores || false,
                ...
                cinturonCopiloto: req.body.parteInterna.cinturonCopiloto || false,
                cinturonPasajeros: req.body.parteInterna.cinturonPasajeros || false,
                espejoRetrovisor: req.body.parteInterna.espejoRetrovisor || false,
            ...
            estadoCubiertas: {
                llantaDelanteraDerecha: req.body.estadoCubiertas.llantaDelanteraDerecha || false,
                llantaDelanteraIzquierda: req.body.estadoCubiertas.llantaDelanteraIzquierda || false,
                llantaPosteriorDerecha: req.body.estadoCubiertas.llantaPosteriorDerecha || false,
                llantaPosteriorIzquierda: req.body.estadoCubiertas.llantaPosteriorIzquierda || false,
                llantaRepuesto: req.body.estadoCubiertas.llantaRepuesto || false,
                presionNeumaticos: req.body.estadoCubiertas.presionNeumaticos || false
            },
            accesoriosSeguridad: {
                conosSeguridad: req.body.accesoriosSeguridad.conosSeguridad || false,
                extintor: req.body.accesoriosSeguridad.extintor || false,
                alarmaRetroceso: req.body.accesoriosSeguridad.alarmaRetroceso || false,
                bosina: req.body.accesoriosSeguridad.bosina || false,
                radioComunicacion: req.body.accesoriosSeguridad.radioComunicacion || false,
                linternaMano: req.body.accesoriosSeguridad.linternaMano || false
            },
            tapasyOtros: {
                tapaTanqueGasolina: req.body.tapasyOtros.tapaTanqueGasolina || false,
                gataHidraulica: req.body.tapasyOtros.gataHidraulica || false,
                herramientasPalancaRuedas: req.body.tapasyOtros.herramientasPalancaRuedas || false,
                cablePasaCorriente: req.body.tapasyOtros.cablePasaCorriente || false,
                eslingasZunchos: req.body.tapasyOtros.eslingasZunchos || false,
                OtrasHerramientas: req.body.tapasyOtros.OtrasHerramientas || false
            },
            documentacion: {
                tarjetaPropiedad: req.body.documentacion.tarjetaPropiedad || false,
                PapelesSeguro: req.body.documentacion.PapelesSeguro || false,
                autorizacionTransito: req.body.documentacion.autorizacionTransito || false,
                licenciaConducir: req.body.documentacion.licenciaConducir || false,
